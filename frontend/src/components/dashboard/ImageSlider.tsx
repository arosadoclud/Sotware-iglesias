          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <motion.div
                ...
                className={`w-11 h-11 bg-gradient-to-br ${style.gradient} rounded-xl flex items-center justify-center shadow-lg`}
              >
        ...
        <div className="relative" style={{ perspective: '1500px' }}>
          <AnimatePresence initial={false} custom={direction} mode="wait">
            ...
            >
              <div className="relative">
                {/* Imagen principal */}
                <div className="relative h-[400px] sm:h-[450px] lg:h-[500px] overflow-hidden bg-neutral-900">
                  <motion.img
                    src={slide.url}
                    alt={slide.title}
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8">
                    ...
                    >
                      ...
                      {slide.description && (
                        <p className="text-lg sm:text-xl text-white/90 mb-4 max-w-3xl drop-shadow-lg">
                          {slide.description}
                        </p>
                      )}
                      ...
                      <div className="flex flex-wrap gap-3 mb-4">
                        {slide.date && (
                          <motion.div
                            ...
                            className="flex items-center gap-2 px-4 py-2 bg-white/20 backdrop-blur-md rounded-lg border border-white/30"
                          >
                            <Calendar className="w-4 h-4 text-white" />
                            <span className="text-sm font-semibold text-white">{slide.date}</span>
                          </motion.div>
                        )}
                        {slide.time && (
                          <motion.div
                          ...
                          >
                            ...
                            <span className="text-sm font-semibold text-white">{slide.time}</span>
                          </motion.div>
                        )}
                        {slide.location && (
                          <motion.div
                          ...
                          >
                            ...
                            <span className="text-sm font-semibold text-white">{slide.location}</span>
                          </motion.div>
                        )}
                        {slide.attendees && (
                          <motion.div
                          ...
                          >
                            ...
                            <span className="text-sm font-semibold text-white">{slide.attendees} asistentes</span>
                          </motion.div>
                        )}
                      </div>
                      ...
                      <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                        <Button className={`bg-gradient-to-r ${style.gradient} text-white border-0 shadow-xl hover:shadow-2xl transition-all px-6 py-3 text-base font-semibold`}>
                          Más información
