          ...
          <AnimatePresence>
            {!collapsed && (
              ...
              >
                ...
                <div>
                  <h1 className="font-bold text-neutral-900 text-sm">Programa de</h1>
                  <p className="text-xs text-neutral-500 -mt-0.5">Oportunidades</p>
                </div>
              </motion.div>
            )}
          </AnimatePresence>
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <>
            ...
            >
              <div className="flex items-center gap-3 h-16 px-6 border-b border-neutral-200">
                <div className="w-10 h-10 bg-gradient-to-br from-primary-500 to-primary-700 rounded-xl flex items-center justify-center shadow-md">
                  <Church className="w-6 h-6 text-white" />
                </div>
                <div>
                  <h1 className="font-bold text-neutral-900">Programa de</h1>
                  <p className="text-xs text-neutral-500 -mt-0.5">Oportunidades</p>
                </div>
              </div>
              <nav className="p-4 space-y-1">
