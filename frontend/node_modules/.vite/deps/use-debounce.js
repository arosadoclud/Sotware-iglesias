...
function c(e2, u2, c2, i2) {
  var l2 = this, a2 = (0, import_react.useRef)(null), o = (0, import_react.useRef)(0), f = (0, import_react.useRef)(0), v = (0, import_react.useRef)(null), d = (0, import_react.useRef)([]), m = (0, import_react.useRef)(), s = (0, import_react.useRef)(), g = (0, import_react.useRef)(e2), h = (0, import_react.useRef)(true), x = (0, import_react.useRef)(), E = (0, import_react.useRef)();
  g.current = e2;
  ...
  var y = !!(c2 = c2 || {}).leading, w = !("trailing" in c2) || !!c2.trailing, O = !!c2.flushOnExit && w, F = "maxWait" in c2, L = "debounceOnServer" in c2 && !!c2.debounceOnServer, A = F ? Math.max(+c2.maxWait || 0, u2) : null, D = (0, import_react.useMemo)(function() {
    var r2 = function(r3) {
      ...
      return !a2.current || n3 >= u2 || n3 < 0 || F && r3 - o.current >= A;
    }, e3 = function(n3) {
      ...
      if (h.current) {
        var i3 = u2 - (c4 - a2.current), l3 = F ? Math.min(i3, A - (c4 - o.current)) : i3;
        n2(r3, l3);
      }
    }, D2 = function() {
      i2 && i2({});
      ...
      if (b || L) {
        ...
        if (d.current = [].slice.call(arguments), m.current = l2, a2.current = i3, O && !x.current && (x.current = function() {
          var r3;
          ...
          if (!v.current && h.current) return o.current = a2.current, n2(c3, u2), y ? r2(a2.current) : s.current;
          if (F) return n2(c3, u2), r2(a2.current);
        }
    ...
    return S.cancel = function() {
      var r3 = v.current;
      r3 && (p ? cancelAnimationFrame(v.current) : clearTimeout(v.current)), o.current = 0, d.current = a2.current = m.current = v.current = null, r3 && i2 && i2({});
    }, S.isPending = function() {
      return !!v.current;
    }, S.flush = function() {
      return v.current ? e3(Date.now()) : s.current;
    }, S;
  }, [y, F, u2, A, w, O, p, b, L, i2]);
